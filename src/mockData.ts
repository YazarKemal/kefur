...
export const INITIAL_ASSETS: Asset[] = [
  {
    ...
    high24h: 95100.00,
    low24h: 91120.50,
    history: [91200, 91500, 91120, 91800, 92400, 92100, 92900, 93200, 93100, 93500, 93900, 93700, 94200, 94500, 94250],
    description: 'Bitcoin is the first decentralized digital currency. It was created in 2009 by an anonymous person or group of people using the pseudonym Satoshi Nakamoto.'
  },
  {
    symbol: 'ETH',
    name: 'Ethereum',
    ...
    high24h: 3550.80,
    low24h: 3410.20,
    history: [3510, 3530, 3540, 3520, 3490, 3480, 3460, 3470, 3450, 3430, 3420, 3460, 3470, 3462, 3450],
  ...
  },
  {
    ...
    high24h: 186.20,
    low24h: 172.50,
    history: [173, 174, 172.5, 175, 176.5, 178, 177, 179.5, 181, 180.5, 182, 181.5, 183.2, 185, 184.75],
    description: 'Solana is a high-performance blockchain supporting builders globally to create crypto apps that scale today. It focuses on transaction speed and throughput.'
  },
  {
    symbol: 'AAPL',
    name: 'Apple Inc.',
